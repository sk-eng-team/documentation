...
```bash cURL
curl -G https://api.external.hirednow.ai/campaigns/role/results \
...
```bash cURL
curl https://api.external.hirednow.ai/campaigns/role/results \
  -H "Authorization: Bearer sk_test_key"\
  -d campaign_id=320009f5-eb09-4a58-94a8-aad39e6ddd14
```
...
```bash cURL
curl -G https://api.external.hirednow.ai/campaigns \
  -H "Authorization: Bearer sk_test_key" \
  -d campaign_id=320009f5-eb09-4a58-94a8-aad39e6ddd14 \
